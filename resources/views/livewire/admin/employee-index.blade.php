                ...
                <x-table.tbody>
                    @foreach ($employees as $employee)
                        @php
                            ...
                            $colors = ['#fdf2fa', '#e0f7fa', '#fff3e0', '#e8f5e9', '#f3e5f5'];
                        ...
                        <tr>
                            ...
                            <x-table.td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex h-10 w-10 items-center justify-center rounded-full"
                                        ...
                                        <span class="text-xs font-semibold text-[#dd2590]">{{ $initials }}</span>
                                    </div>
                                    <div>
                            ...
                            <x-table.td class="items-center">
                                <div class="flex justify-center items-center gap-4">
                                    <a wire:navigate href="{{ route('admin.employee.show', $employee->id) }}">
                                    ...
                                    <a wire:navigate href="{{ route('admin.employee.edit', $employee->id) }}">
                                    ...
                                    <a wire:navigate href="{{ route('admin.employee.destroy', $employee->id) }}">
