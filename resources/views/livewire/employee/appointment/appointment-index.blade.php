    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-200 mb-6">
        <div class="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
            ...
            <div class="flex-1 w-full md:max-w-md">
                <div class="relative">
                    <span class="absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none text-indigo-600">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search"
                        ...
                        class="h-10 w-full rounded-lg border border-gray-300 bg-white pl-[42px] pr-4 py-2.5 text-sm text-gray-700 placeholder:text-gray-400 focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600 focus:outline-hidden">
                </div>
            </div>
