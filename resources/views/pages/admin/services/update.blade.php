...
@section('main')
    ...
    {{-- Form Container --}}
    <x-form.container action="{{ route('admin.services.update', $service->id) }}" method="PUT" enctype="multipart/form-data">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <x-form.textarea name="description" id="service_description" rows="4"
                        placeholder="Describe the service in detail...">{{ $service->description ?? old('description') }}</x-form.textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-form.select id="category" name="category" :options="[
                            ...
                            'Other' => 'Other',
                        ]" :selected="$service->category ?? old('category')"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-form.input id="price" name="price" type="number" min="0" step="0.01"
                            placeholder="0.00" value="{{ $service->price ?? old('price') }}" class="pl-8" />
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        @if ($service->service_img)
                            <div id="currentImageContainer" class="mb-4">
                                ...
                                <p class="text-xs text-gray-500 mt-2 text-center">Current image - Upload new to replace</p>
                            </div>
                        @endif
        ...
        <div class="mt-8 flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            <x-form.button type="submit" text="Update Service">
...
@push('scripts')
    ...
    <script>
        ...
        function clearImage() {
            ...
            // Show current image or upload label
            const currentContainer = document.getElementById('currentImageContainer');
            if (currentContainer) {
